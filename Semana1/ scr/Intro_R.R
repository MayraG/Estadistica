# SEMANA 2, PRÁCTICA 1 - Introducción al lenguaje de programación en R
...
# Ejercicio 6: Hasta el momento, hemnos generadores varios vectores / objetos / variables, podemos listarlas
...
# Ejercicio 7: Cree una secuencia que repita los números de 1 a 4, 3 veces y asígnela a un objeto llamado
...
# Ejercicio 8: Tomo la primera columna y la segunda, concaténelas con c () ¿Qué encuentra?
